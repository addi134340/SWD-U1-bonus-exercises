...
console.log(`The old drill is cordless. This is ${oldDrill.cordless}.`);

// TRY IT! Use dot notation to print the voltage of newDrill's battery.

console.log(`The voltage of the new drill's battery is ${newDrill.battery}.`);
